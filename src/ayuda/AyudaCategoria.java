 ...
 */
public class AyudaCategoria extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\n\n\n\n\nPUEDE CREAR, LEER, ACTUALIZAR Y ELIMINAR (CAMBIAR SU \nESTADO A INACTIVO) LA CATEGORÍA Y SU INFORMACIÓN. NO \nES NECESARIO ESCRIBIR ALGO EN EL \"CÓDIGO\", A MENOS QUE \nQUIERA REALIZAR UNA BÚSQUEDA DE UNA CATEGORÍA, YA SE \nUNA BÚSQUEDA POR NOMBRE O POR CÓDIGO DE CATEGORÍA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaCategoria dialog = new AyudaCategoria(new javax.swing.JFrame(), true);
