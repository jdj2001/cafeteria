 ...
 */
public class AyudaProveedores extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\n\n\n\n\n\nPUEDE CREAR, LEER, ACTUALIZAR Y ELIMINAR (CAMBIAR SU \nESTADO A INACTIVO) A LOS PROVEEDORES Y SU INFORMACIÓN\nE INCLUSO AÑADIR UNA FOTO DE ESTOS. SI NO QUIERE, AÑADA \nLA FOTO \"SIN PERFIL\". NO ES NECESARIO ESCRIBIR ALGO EN EL \n\"CÓDIGO\", A MENOS QUE QUIERA REALIZAR UNA BÚSQUEDA DE \nALGÚN PROVEEDOR, YA SE UNA BÚSQUEDA POR NOMBRE O POR \nCÓDIGO DEL CLIENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaProveedores dialog = new AyudaProveedores(new javax.swing.JFrame(), true);
