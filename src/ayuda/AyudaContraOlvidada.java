 ...
 */
public class AyudaContraOlvidada extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaContraOlvidada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\n\n\n\n\nINGRESE SU CORREO Y DÉ CLIC EN EL BOTÓN \"BUSCAR\" PARA \nENCONTRAR SU CORREO. LUEGO SE LE MOSTRARÁ SU PREGUNTA \nDE SEGURIDAD Y DEBERÁ INGRESAR SU RESPUESTA, SI ESTAS \nCOINCIDEN, INGRESE SU NUEVA CONTRASEÑA Y DE CLIC EN EL \nBOTÓN \"ACYUALIZAR\" PARA RELIZAR LOS CAMBIOS.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaContraOlvidada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaContraOlvidada dialog = new AyudaContraOlvidada(new javax.swing.JFrame(), true);
