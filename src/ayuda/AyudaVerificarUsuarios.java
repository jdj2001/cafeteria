 ...
 */
public class AyudaVerificarUsuarios extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaVerificarUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\n\n\n\n\nPUEDE ESCRIBIR EN LA CAJA DE TEXTO UN NOMBRE O CORREO \nDE USUARIO ESPECÍFICO PARA HACER UNA BÚSQUEDA EN LA \nTABLA INFERIOR DONDE SE MUESTRAN TODOS LOS USUARIOS. \nDE CLIC EN UNA FILA (USUARIO) PARA CAMBIAR SU ESTADO A \nACTIVO/INACTIVO.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaVerificarUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaVerificarUsuarios dialog = new AyudaVerificarUsuarios(new javax.swing.JFrame(), true);
