 ...
 */
public class AyudaRegistrarRol extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaRegistrarRol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\n\n\n\n\n\n\n\nREGISTRE UN ROL NO EXISTENTE. SOLO ESCRIBA EN LA \nDESCRIPCIÓN. TAMBIÉN PUEDE HACER UNA BÚSQUEDA DE \nUN ROL EXISTENTE Y MODIFICARLO.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaRegistrarRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaRegistrarRol dialog = new AyudaRegistrarRol(new javax.swing.JFrame(), true);
