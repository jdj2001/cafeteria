 ...
 */
public class AyudaClientes extends javax.swing.JDialog {

    /**
     * Creates new form AyudaReportes
     */
    public AyudaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AyudaClientes dialog = new AyudaClientes(new javax.swing.JFrame(), true);
