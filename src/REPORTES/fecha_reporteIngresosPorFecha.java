 ...
 */
public class fecha_reporteIngresosPorFecha extends javax.swing.JPanel {
    ...
    Object datosFecha[] = new Object[5];
    private reportePrincipal frame;
    private static String correoUsu;

    /**
     * Creates new form fecha_reporteIngresosPorFecha
     * @param principal
     */
    public fecha_reporteIngresosPorFecha(JFrame principal) {
        initComponents();
        conectarBD();
    ...
    public void reportePorFechas() {
        encontrado = "NO";
        try {
            sentenciaSQL = "SELECT codigoProducto, producto, cantidad, fecha, total FROM factura WHERE fecha BETWEEN ? AND ?";
            ps = con.prepareStatement(sentenciaSQL);
            ps.setDate(1, f1);
            ps.setDate(2, f2);
            rs = ps.executeQuery();
            ...
            while (rs.next()) {
                datosFecha[0] = rs.getInt("codigoProducto");
                datosFecha[1] = rs.getString("producto");
                datosFecha[2] = rs.getString("cantidad");
                datosFecha[3] = rs.getDate("fecha");
                datosFecha[4] = rs.getInt("total");
                modelo.addRow(datosFecha);
                encontrado = "SI";
            }
            if (encontrado.equals("NO")) {
    ...
    public void crearReportePDF() {
        ...
        try {
            ...
            PdfWriter.getInstance(reporte, new FileOutputStream(ruta + "/Desktop/REPORTES/Reporte_IngresosPorFechas.pdf"));
    ...
    public void BuscarEnBD(java.sql.Date fechaInicio, java.sql.Date fechaFin) {
        try {
            ...
            sentenciaSQL = "SELECT codigoProducto, producto, fecha, total FROM factura WHERE fecha BETWEEN ? AND ?";
    ...
    public void abrirReporte() {
        try {
            ...
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + ruta + "/Desktop/REPORTES/Reporte_IngresosPorFechas.pdf");
    ...
    public void reportePorFechasiReport() {
        try {
            ...
            //RUTA DEL ARCHIVO
            URL urlMaestro = getClass().getResource("/REPORTES/fecha_reporteIngresosPorFecha_1.jasper");
            //LLAMADO DEL ARCHIVO
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnObtenerFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 90, 110, 30));
        ...
        tblDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "PRODUCTO", "CANTIDAD", "FECHA", "TOTAL"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 1140, 240));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("FECHA FINAL");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, -1, 30));
        jPanel1.add(jdcFecha2, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 90, 140, 30));

        jdcFecha1.setDateFormatString("dd-MM-yyyy");
        jPanel1.add(jdcFecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 90, 150, 30));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("FECHA INICIAL");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, -1, 30));
        ...
        jPanel1.add(btnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, 110, 30));
        ...
        jPanel1.add(btnPDF, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 220, 150, 30));
        ...
        jPanel1.add(btnReport, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 220, 190, 30));

        add(jPanel1);
        jPanel1.setBounds(10, 270, 1170, 530);
        ...
        add(btnCerrar);
        btnCerrar.setBounds(1123, 0, 60, 49);
        add(jblLogo);
        jblLogo.setBounds(10, 10, 260, 230);
        add(jblFondo);
        jblFondo.setBounds(0, 0, 1190, 820);
